...
%
% This script runs the matrix spd projection example 
%
% NS, EK, VP August 21
...
tic; 
eps = 1e-15;
[p, q, ~] = RationalMinMaxOpt_pos(fun, n+1, m+1, pts, l, u, a, b, eps); 
time_opt = toc;
...
legend({'Original','Projected'},'Interpreter','latex')
set(gca,'FontSize',18)
...
legend('Optimization','Remez polynomial','AAA','Location','NorthWest')
grid on
set(gca,'FontSize',18)
